<?php 
	...
	if(isset($_GET['login_as_rest']))
	{
		$rest_login_id = $_GET['login_as_rest'];
		
		$_SESSION['current_login_restaurant']	=	$rest_login_id;
...
<?php
			...
			?>	
					<tr>
						...
						<td><a href="hotels_report.php?login_as_rest=<?php echo $userid; ?>">Login</a></td>

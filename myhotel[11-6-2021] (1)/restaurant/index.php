...
$password		=	"";
	...
	{
		unset($_SESSION['current_login_restaurant']);	
	}
	...
	if(isset($_POST['login']))
	{
	  ...
	  $password       		= $_POST['password'];
	    ...
	    $db_password 		= $db->get_password_restaurant($email_id);
		...
		if($flag == 0)
		{
			...
			{
				$_SESSION['current_login_restaurant']=$email_id;
                    ...
                    <div class="col-md-6">
                        <div class="ibox">
                            <form class="form-pink" method="post" action="<?php echo $_SERVER['PHP_SELF']?>" name="myForm" onsubmit="return validateForm()" autocomplete="off">
								...
								?>	
                                <div class="ibox-head">
                                    <div class="ibox-title">RESTAURANT LOGIN</div>
                                </div>
                                <div class="ibox-body">
